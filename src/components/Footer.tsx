...
const socialLinks = [
    { name: 'GitHub', url: 'https://github.com/dhruvakhariaa', icon: 'github' },
    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/dhruv-vakharia', icon: 'linkedin' },
    { name: 'Instagram', url: 'https://www.instagram.com/grow.alongside.me/', icon: 'instagram' },
    { name: 'Email', url: 'mailto:vakhariadhruv526@gmail.com', icon: 'email' },
];
        ...
        switch (pathname) {
            case '/projects':
                return {
                    ...
                    subtitle: "I'm always excited to work on new challenges. Let's bring your ideas to life.",
                    button: 'Start a Project',
                };
            case '/contact':
                return {
                    heading: 'Get In Touch',
                    subtitle: "Whether it's a question or a collaboration, I'd love to hear from you.",
                    button: 'Say Hello',
                };
            default:
                return {
